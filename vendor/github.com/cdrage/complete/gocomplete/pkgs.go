...
func predictLocalAndSystem(a complete.Args) []string {
	...
	// System directories are not actual file names, for example: 'github.com/cdrage/complete' could
	// be the argument, but the actual filename is in $GOPATH/src/github.com/cdrage/complete'. this
